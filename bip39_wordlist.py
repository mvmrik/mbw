...
# Index starts at 1 (word at position 0 in list = index 1)
...
BIP39_WORDS = [
    ...
    "cause", "cave", "ceiling", "celery", "cement", "census", "century", "cereal",
    ...
    "frequent", "fresh", "friend", "fringe", "frog", "front", "frown", "frozen",
    ...
    "hood", "hope", "horn", "horror", "horse", "hospital", "host", "hour",
    ...
    "pulp", "pulse", "pumpkin", "punish", "pupil", "purchase", "purity", "purpose",
    ...
    "review", "reward", "rhythm", "ribbon", "rice", "rich", "ride", "ridge",
    ...
    "strike", "strong", "struggle", "student", "stuff", "stumble", "subject", "submit",
...
# Build lookup dict: word -> index (1-based)
BIP39_INDEX = {word: idx + 1 for idx, word in enumerate(BIP39_WORDS)}

def get_word_index(word: str) -> int:
    """Returns 1-based BIP39 index for a word, or 0 if not found."""
    return BIP39_INDEX.get(word.lower().strip(), 0)

def get_word_by_index(index: int) -> str:
    """Returns the word for a 1-based index, or empty string if invalid."""
    if 1 <= index <= len(BIP39_WORDS):
        return BIP39_WORDS[index - 1]
    return ""